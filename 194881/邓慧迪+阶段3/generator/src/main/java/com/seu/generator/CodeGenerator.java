...
public class CodeGenerator {
    ...
    private static DataSourceConfig dataSourceConfig() {
        ...
        dsconfig.setUrl("jdbc:mysql://127.0.0.1:3306/mp?serverTimezone=GMT%2B8&useUnicode=true&useSSL=false&characterEncoding=utf8");
        dsconfig.setUsername("root");
        dsconfig.setPassword("asdf&1234");
        return dsconfig;
    }
    ...
    private static StrategyConfig strategyConfig() {
        ...
        strategyConfig.setInclude("user"); // 对应数据库所需要生成的表名
    ...
    private static PackageConfig packageConfig() {
        ...
        packageConfig.setParent("com.seu.generator"); // 所需要生成的包下
